			  ...
			  <main class="shell">
			    <header class="header">
			      <div class="header-content">
			        ...
			        <h1>Understand production incidents faster.</h1>

			        <p class="subtitle">
			          Generate a realistic incident and watch an autonomous agent inspect
			          queue health, failure events, and deployments to produce an
